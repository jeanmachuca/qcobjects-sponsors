    ...
    !function(t) {
        ...
        function v(t, e) {
            ...
            if (t instanceof v) {
                ...
                this.url = String(t);
            if (this.credentials = e.credentials || this.credentials || "omit", !e.headers && this.headers || (this.headers = new f(e.headers)), this.method = (r = e.method || this.method || "GET", n = r.toUpperCase(), i.indexOf(n) > -1 ? n : r), this.mode = e.mode || this.mode || null, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && o)
        ...
        try {
            ...
            if (e && ("object" == typeof e || "function" == typeof e)) {
                ...
                if ("function" == typeof n)
                    return void a((o = n, u = e, function() {
                        o.apply(u, arguments)
                    }), t)
            }
    ...
    var f = c(function(t) {
        ...
        g = function(t, e) {
            ...
            if (e && "function" == typeof (r = t.toString) && !l(n = r.call(t)))
                return n;
            if ("function" == typeof (r = t.valueOf) && !l(n = r.call(t)))
                return n;
            if (!e && "function" == typeof (r = t.toString) && !l(n = r.call(t)))
                return n;
    ...
    var St = c(function(t) {
        ...
        It = function() {
            var t,
                e = m("iframe"),
                r = pt.length;
            for (e.style.display = "none", Lt.appendChild(e), e.src = "javascript:", (t = e.contentWindow.document).open(), t.write("<script>document.F=Object<\/script>"), t.close(), It = t.F; r--;)
        ...
        stringify: function(t) {
            ...
            if (r = e = n[1], (l(e) || void 0 !== t) && !fe(t))
                return H(e) || (e = function(t, e) {
                    if ("function" == typeof r && (e = r.call(this, t, e)), !fe(e))
                        return e
                }), n[1] = e, Xt.apply(Yt, n)
        }
